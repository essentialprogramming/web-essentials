...
import com.api.resources.ByteArrayServlet;
import com.api.resources.WelcomeServlet;
import com.api.resources.HelloWorldServlet;
	...
	private HttpHandler bootstrap() throws ServletException {
		final DeploymentInfo servletBuilder = deployment()
				...
				.addServlets(
		                ...
		                servlet("hello", HelloWorldServlet.class)
			            	.addMapping("/hello/*")
				            .setLoadOnStartup(1),
						servlet("welcome", WelcomeServlet.class)
								.addMapping("/welcome/*")
								.setLoadOnStartup(1),
						servlet("stream", ByteArrayServlet.class)
								.addMapping("/stream/*")
								.setLoadOnStartup(1)
				);
